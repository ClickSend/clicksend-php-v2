...
------------ | ------------- | ------------- | -------------
**http_code** | **string** | The HTTP code of the response. Visit [this page](/#status-codes) for more information. | [optional]
...
**data** | [**\ClickSend\Model\SmsTemplateUpdate**](SmsTemplateUpdate.md) |  | [optional]
