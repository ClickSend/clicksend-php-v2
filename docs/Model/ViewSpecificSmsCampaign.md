...
**response_code** | **string** | The response code of the operation. Visit Visit [this page](/#status-codes) for more information. | [optional]
**response_msg** | **string** | A message describing the outcome of the operation. | [optional]
**data** | [**\ClickSend\Model\SmsCampaign**](SmsCampaign.md) |  | [optional]
