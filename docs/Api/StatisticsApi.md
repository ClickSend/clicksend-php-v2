...
```php
viewSmsStatistics($content_type): \ClickSend\Model\ViewSmsStatistics
```
...
try {
    $result = $apiInstance->viewSmsStatistics($content_type);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling StatisticsApi->viewSmsStatistics: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ClickSend\Model\ViewSmsStatistics**](../Model/ViewSmsStatistics.md)
...
```php
viewVoiceStatistics($content_type): \ClickSend\Model\ViewVoiceStatistics
```
...
try {
    $result = $apiInstance->viewVoiceStatistics($content_type);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling StatisticsApi->viewVoiceStatistics: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ClickSend\Model\ViewVoiceStatistics**](../Model/ViewVoiceStatistics.md)
