...
/**
 * ListCountriesDataInner Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ListCountriesDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'list_countries_data_inner';
     ...
     * Sets code
     *
     * @param string|null $code The code of the country.
     *
     * @return self
     */
