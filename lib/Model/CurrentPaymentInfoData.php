...
/**
 * CurrentPaymentInfoData Class Doc Comment
 *
 * @category Class
 ...
 */
class CurrentPaymentInfoData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'current_payment_info_data';
     ...
     * Sets display_number
     *
     * @param string|null $display_number The credit card number.
     *
     * @return self
     */
     ...
     * Sets expiry_month
     *
     * @param int|null $expiry_month The credit card expiry month.
     *
     * @return self
     */
     ...
     * Sets expiry_year
     *
     * @param int|null $expiry_year The credit card expiry year.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The credit card name.
     *
     * @return self
     */
