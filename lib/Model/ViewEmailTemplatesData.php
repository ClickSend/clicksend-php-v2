...
/**
 * ViewEmailTemplatesData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewEmailTemplatesData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_email_templates_data';
    ...
    protected static $openAPITypes = [
        ...
        'from' => 'int',
        'to' => 'int',
        'data' => '\ClickSend\Model\ViewEmailTemplatesDataDataInner[]'
    ];
     ...
     * Sets from
     *
     * @param int|null $from The index of the first record in the page.
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param int|null $to The index of the last record in the page.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewEmailTemplatesDataDataInner[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewEmailTemplatesDataDataInner[]|null $data data
     *
     * @return self
     */
