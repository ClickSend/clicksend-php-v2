...
/**
 * CalculateEmailCampaignPriceDataData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CalculateEmailCampaignPriceDataData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'calculate_email_campaign_price_data_data';
     ...
     * Sets subject
     *
     * @param string|null $subject Your template subject.
     *
     * @return self
     */
     ...
     *
     * @param float|null $from_email_address_id The allowed email address id.
     *
     * @return self
     */
     ...
     * Sets from_name
     *
     * @param string|null $from_name Your sender name.
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string|null $body Your message.
     *
     * @return self
     */
     ...
     * Sets list_id
     *
     * @param float|null $list_id Your list id.
     *
     * @return self
     */
