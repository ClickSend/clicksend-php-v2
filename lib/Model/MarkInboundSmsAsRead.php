...
/**
 * MarkInboundSmsAsRead Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class MarkInboundSmsAsRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'mark-inbound-sms-as-read';
     ...
     * Sets data
     *
     * @param object|null $data The parameters related to the inbound SMS.  <div class=\"warning-box\">   <h4><i class=\"fas fa-exclamation-triangle\"></i> Warning:</h4>   <p>This parameter is deprecated and will return <strong>null</strong/>.</p> </div>
     *
     * @return self
     */
