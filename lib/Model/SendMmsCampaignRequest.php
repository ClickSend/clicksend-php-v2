...
/**
 * SendMmsCampaignRequest Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class SendMmsCampaignRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'send_mms_campaign_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('media_file', $data ?? [], null);
    }
     ...
     * Sets url_to_shorten
     *
     * @param string|null $url_to_shorten url_to_shorten
     *
     * @return self
     */
     ...
     * Sets media_file
     *
     * @param string|null $media_file media_file
     *
     * @return self
     */
    public function setMediaFile($media_file)
    {
        if (is_null($media_file)) {
            throw new \InvalidArgumentException('non-nullable media_file cannot be null');
        }
