...
/**
 * ViewFaxInboundRulesData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewFaxInboundRulesData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_fax_inbound_rules_data';
    ...
    protected static $openAPITypes = [
        ...
        'from' => 'int',
        'to' => 'int',
        'data' => '\ClickSend\Model\InboundFaxRule[]'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\InboundFaxRule[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\InboundFaxRule[]|null $data data
     *
     * @return self
     */
