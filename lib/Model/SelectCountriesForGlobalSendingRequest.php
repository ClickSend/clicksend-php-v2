...
/**
 * SelectCountriesForGlobalSendingRequest Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class SelectCountriesForGlobalSendingRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'select_countries_for_global_sending_request';
    ...
    protected static $setters = [
        'country_list_ids' => 'setCountryListIds'
    ];
    ...
    protected static $getters = [
        'country_list_ids' => 'getCountryListIds'
    ];
    ...
    {
        $this->setIfExists('country_list_ids', $data ?? [], null);
    }
    ...
    /**
     * Gets country_list_ids
     *
     * @return int[]|null
     */
    public function getCountryListIds()
    {
        return $this->container['country_list_ids'];
    }

    /**
     * Sets country_list_ids
     *
     * @param int[]|null $country_list_ids country_list_ids
     *
     * @return self
     */
    public function setCountryListIds($country_list_ids)
    {
        if (is_null($country_list_ids)) {
            throw new \InvalidArgumentException('non-nullable country_list_ids cannot be null');
        }
        $this->container['country_list_ids'] = $country_list_ids;
