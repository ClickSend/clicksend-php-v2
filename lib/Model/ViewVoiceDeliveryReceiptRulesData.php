...
/**
 * ViewVoiceDeliveryReceiptRulesData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewVoiceDeliveryReceiptRulesData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_voice_delivery_receipt_rules_data';
    ...
    protected static $openAPITypes = [
        ...
        'from' => 'int',
        'to' => 'int',
        'data' => '\ClickSend\Model\VoiceDeliveryReceiptRule[]'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\VoiceDeliveryReceiptRule[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\VoiceDeliveryReceiptRule[]|null $data data
     *
     * @return self
     */
