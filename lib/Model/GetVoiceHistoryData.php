...
/**
 * GetVoiceHistoryData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class GetVoiceHistoryData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'get_voice_history_data';
    ...
    protected static $openAPITypes = [
        ...
        'from' => 'int',
        'to' => 'int',
        'data' => '\ClickSend\Model\VoiceMessage[]'
    ];
     ...
     * Sets data
     *
     * @param \ClickSend\Model\VoiceMessage[]|null $data data
     *
     * @return self
     */
