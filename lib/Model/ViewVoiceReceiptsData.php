...
/**
 * ViewVoiceReceiptsData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewVoiceReceiptsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_voice_receipts_data';
    ...
    protected static $openAPITypes = [
        ...
        'from' => 'int',
        'to' => 'int',
        'data' => '\ClickSend\Model\VoiceReceipt[]'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\VoiceReceipt[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\VoiceReceipt[]|null $data data
     *
     * @return self
     */
