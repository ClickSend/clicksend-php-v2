...
/**
 * EmailDeliveryReceiptRule Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class EmailDeliveryReceiptRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'email_delivery_receipt_rule';
     ...
     * Sets match_type
     *
     * @param int|null $match_type The type of match for the rule.
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action The action to be taken by the rule.
     *
     * @return self
     */
