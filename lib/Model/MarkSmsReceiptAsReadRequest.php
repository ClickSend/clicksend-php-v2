...
/**
 * MarkSmsReceiptAsReadRequest Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class MarkSmsReceiptAsReadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'mark_sms_receipt_as_read_request';
     ...
     * Sets date_before
     *
     * @param int|null $date_before The cutoff date. Receipts sent before this time will be marked as read. It’s in the <a target=\"_blank\" href=\"http://help.clicksend.com/what-is-a-unix-timestamp\">Unix format</a>.
     *
     * @return self
     */
