...
/**
 * ViewAccountUsageDataEmailInner Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewAccountUsageDataEmailInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_account_usage_data_email_inner';
     ...
     * Sets total_count
     *
     * @param int|null $total_count The total count of emails.
     *
     * @return self
     */
