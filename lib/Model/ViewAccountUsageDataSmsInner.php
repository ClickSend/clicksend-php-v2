...
/**
 * ViewAccountUsageDataSmsInner Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewAccountUsageDataSmsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_account_usage_data_sms_inner';
     ...
     * Sets total_count
     *
     * @param string|null $total_count The total count of SMS.
     *
     * @return self
     */
