...
/**
 * ViewSpecificClientAccount Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewSpecificClientAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view-specific-client-account';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\CreateResellerAccountData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\CreateResellerAccountData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\CreateResellerAccountData|null $data data
     *
     * @return self
     */
