...
/**
 * ViewYourReturnAddressesData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewYourReturnAddressesData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_your_return_addresses_data';
    ...
    protected static $openAPITypes = [
        ...
        'from' => 'int',
        'to' => 'int',
        'data' => '\ClickSend\Model\PostReturnAddress[]'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\PostReturnAddress[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\PostReturnAddress[]|null $data data
     *
     * @return self
     */
