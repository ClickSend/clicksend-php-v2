...
/**
 * ViewEmailTemplatesDataDataInner Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewEmailTemplatesDataDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_email_templates_data_data_inner';
     ...
     * Sets template_id
     *
     * @param int|null $template_id The ID of the email template.
     *
     * @return self
     */
     ...
     * Sets template_name
     *
     * @param string|null $template_name The name of the email template.
     *
     * @return self
     */
