...
/**
 * SendEmailCampaignData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class SendEmailCampaignData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'send_email_campaign_data';
    ...
    protected static $openAPITypes = [
        ...
        'total_price' => 'string',
        'queued_count' => 'float',
        'data' => '\ClickSend\Model\EmailCampaign',
    ...
    {
        $this->setIfExists('totlal_count', $data ?? [], null);
     ...
     * @return float|null
     */
    public function getTotlalCount()
    {
        return $this->container['totlal_count'];
    }

    /**
     * Sets totlal_count
     *
     * @param float|null $totlal_count The total count of the email campaigns.
     *
     * @return self
     */
    public function setTotlalCount($totlal_count)
    {
        if (is_null($totlal_count)) {
            throw new \InvalidArgumentException('non-nullable totlal_count cannot be null');
        }
        $this->container['totlal_count'] = $totlal_count;
     ...
     * Sets total_price
     *
     * @param string|null $total_price The total price of the email campaigns.
     *
     * @return self
     */
     ...
     * Sets queued_count
     *
     * @param float|null $queued_count The count of the queued email campaigns.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \ClickSend\Model\EmailCampaign|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\EmailCampaign|null $data data
     *
     * @return self
     */
