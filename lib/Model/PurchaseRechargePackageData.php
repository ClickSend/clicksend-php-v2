...
/**
 * PurchaseRechargePackageData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class PurchaseRechargePackageData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'purchase_recharge_package_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('amount_aud', $data ?? [], null);
     ...
     * Sets amount
     *
     * @param int|null $amount The amount of the package.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency The currency of the package.
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getAmountAud()
    {
        return $this->container['amount_aud'];
    }

    /**
     * Sets amount_aud
     *
     * @param int|null $amount_aud The amount of the package in AUD.
     *
     * @return self
     */
    public function setAmountAud($amount_aud)
    {
        if (is_null($amount_aud)) {
            throw new \InvalidArgumentException('non-nullable amount_aud cannot be null');
        }
        $this->container['amount_aud'] = $amount_aud;
     ...
     * Sets date
     *
     * @param int|null $date The timestamp of when the package was purchased.
     *
     * @return self
     */
