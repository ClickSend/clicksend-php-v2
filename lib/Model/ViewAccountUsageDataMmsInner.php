...
/**
 * ViewAccountUsageDataMmsInner Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewAccountUsageDataMmsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_account_usage_data_mms_inner';
     ...
     * Sets total_count
     *
     * @param string|null $total_count The total count of MMS.
     *
     * @return self
     */
     ...
     * Sets total_price
     *
     * @param string|null $total_price The total price of MMS.
     *
     * @return self
     */
