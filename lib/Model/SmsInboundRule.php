...
/**
 * SmsInboundRule Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class SmsInboundRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'sms_inbound_rule';
     ...
     *
     * @param string|null $dedicated_number The number to be used in the inbound rule.
     *
     * @return self
     */
     ...
     *
     * @param int|null $message_search_type The type of message search to be used in the inbound rule.
     *
     * @return self
     */
     ...
     *
     * @param string|null $message_search_term The message search term to be used in the inbound rule.
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action The action to be taken in the inbound rule.
     *
     * @return self
     */
     ...
     * Sets action_address
     *
     * @param string|null $action_address The action address to be used in the inbound rule.
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string|null $body The body of the inbound rule.
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param int|null $enabled The status of the inbound rule.
     *
     * @return self
     */
