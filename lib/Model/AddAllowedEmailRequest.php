...
/**
 * AddAllowedEmailRequest Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class AddAllowedEmailRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'add_allowed_email_request';
     ...
     * Sets from_fax
     *
     * @param string|null $from_fax from_fax
     *
     * @return self
     */
    ...
    {
        if (is_null($from_fax)) {
            throw new \InvalidArgumentException('non-nullable from_fax cannot be null');
        }
