...
/**
 * DeleteSmsTemplate Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class DeleteSmsTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'delete-sms-template';
     ...
     * Sets data
     *
     * @param string[]|null $data The parameters related to the SMS template.  <div class=\"warning-box\">   <h4><i class=\"fas fa-exclamation-triangle\"></i> Warning:</h4>   <p>This parameter is deprecated and will return <strong>null</strong>.</p> </div>
     *
     * @return self
     */
