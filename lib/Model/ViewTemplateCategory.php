...
/**
 * ViewTemplateCategory Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewTemplateCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view-template-category';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\ViewTemplateCategoryData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewTemplateCategoryData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewTemplateCategoryData|null $data data
     *
     * @return self
     */
