...
/**
 * MasterEmailTemplate Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class MasterEmailTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'master_email_template';
    ...
    {
        $this->setIfExists('template_id_master', $data ?? [], null);
     ...
     *
     * @param int|null $template_id_master The unique identifier for the template.
     *
     * @return self
     */
    public function setTemplateIdMaster($template_id_master)
    {
        if (is_null($template_id_master)) {
            throw new \InvalidArgumentException('non-nullable template_id_master cannot be null');
        }
     ...
     * Sets template_name
     *
     * @param string|null $template_name The name of the template.
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string|null $body The body of the template.
     *
     * @return self
     */
     ...
     * Gets thumbnail
     *
     * @return \ClickSend\Model\MasterEmailTemplateThumbnail|null
     */
     ...
     * Sets thumbnail
     *
     * @param \ClickSend\Model\MasterEmailTemplateThumbnail|null $thumbnail thumbnail
     *
     * @return self
     */
