...
/**
 * ViewTemplateCategoriesDataInner Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewTemplateCategoriesDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_template_categories_data_inner';
     ...
     * Sets category_id
     *
     * @param float|null $category_id The ID of the category.
     *
     * @return self
     */
