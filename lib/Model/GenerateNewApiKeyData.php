...
/**
 * GenerateNewApiKeyData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class GenerateNewApiKeyData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'generate_new_api_key_data';
     ...
     * Sets api_key
     *
     * @param string|null $api_key The new API key
     *
     * @return self
     */
