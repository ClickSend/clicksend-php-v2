...
/**
 * SmsTemplateUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class SmsTemplateUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'sms_template_update';
     ...
     * Sets template_id
     *
     * @param int|null $template_id The generated ID of the template. This remains the same and can’t be updated.
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string|null $body The new updated content of the template.
     *
     * @return self
     */
     ...
     * Sets template_name
     *
     * @param string|null $template_name The new updated name of the template.
     *
     * @return self
     */
