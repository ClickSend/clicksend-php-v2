...
/**
 * DeleteSubaccount Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class DeleteSubaccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'delete-subaccount';
     ...
     * Sets data
     *
     * @param bool|null $data The status of the operation.
     *
     * @return self
     */
