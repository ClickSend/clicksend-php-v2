...
/**
 * ViewSmsHistoryData Class Doc Comment
 *
 * @category Class
 ...
 */
class ViewSmsHistoryData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_sms_history_data';
    ...
    protected static $openAPITypes = [
        ...
        'from' => 'int',
        'to' => 'int',
        'data' => '\ClickSend\Model\ViewSmsHistoryDataAllOfDataInner[]'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewSmsHistoryDataAllOfDataInner[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewSmsHistoryDataAllOfDataInner[]|null $data The parameters related to the actual SMS.
     *
     * @return self
     */
