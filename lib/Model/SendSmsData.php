 ...
 */
class SendSmsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'send_sms_data';
    ...
    protected static $openAPITypes = [
        ...
        'total_count' => 'int',
        'queued_count' => 'int',
        'messages' => '\ClickSend\Model\SmsSendSms[]',
     ...
     * Gets messages
     *
     * @return \ClickSend\Model\SmsSendSms[]|null
     */
     ...
     * Sets messages
     *
     * @param \ClickSend\Model\SmsSendSms[]|null $messages The parameters related to messages.
     *
     * @return self
     */
     ...
     * Sets blocked_count
     *
     * @param int|null $blocked_count The number of messages unable to be sent. This is often caused by:  - Receipient’s country not enabled for <a href=\"https://help.clicksend.com/article/qdavyt16qs-global-sending\">global sending</a>.      - **Sender ID** resitriction.      - Number registration restrcition.
     *
     * @return self
     */
