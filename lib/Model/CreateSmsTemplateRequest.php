...
/**
 * CreateSmsTemplateRequest Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CreateSmsTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'create_sms_template_request';
     ...
     * Sets body
     *
     * @param string|null $body body String The main content of your template.
     *
     * @return self
     */
