...
/**
 * DefaultSenderErrorDetailsInner Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class DefaultSenderErrorDetailsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'default_sender_error_details_inner';
     ...
     * Sets reason
     *
     * @param string|null $reason The error message
     *
     * @return self
     */
