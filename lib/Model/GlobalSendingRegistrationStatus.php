...
/**
 * GlobalSendingRegistrationStatus Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class GlobalSendingRegistrationStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'global_sending_registration_status';
     ...
     * Sets id
     *
     * @param int|null $id The ID of the registration status.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the registration status.
     *
     * @return self
     */
