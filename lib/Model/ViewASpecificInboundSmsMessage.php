...
/**
 * ViewASpecificInboundSmsMessage Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewASpecificInboundSmsMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view-a-specific-inbound-sms-message';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\InboundSms'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\InboundSms|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\InboundSms|null $data data
     *
     * @return self
     */
