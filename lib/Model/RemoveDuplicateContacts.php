...
/**
 * RemoveDuplicateContacts Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class RemoveDuplicateContacts implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'remove-duplicate-contacts';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\RemoveOptedOutContactsData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\RemoveOptedOutContactsData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\RemoveOptedOutContactsData|null $data data
     *
     * @return self
     */
