 ...
 */
class CancelSms implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'cancel-sms';
     ...
     * Sets http_code
     *
     * @param string|null $http_code The HTTP code of the response. Visit [this page](/#status-codes) for more information.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param object|null $data The parameters related to the scheduled SMS.  <div class=\"warning-box\">   <h4><i class=\"fas fa-exclamation-triangle\"></i> Warning:</h4>   <p>This parameter is deprecated and will return <strong>null</strong/>.</p> </div>
     *
     * @return self
     */
