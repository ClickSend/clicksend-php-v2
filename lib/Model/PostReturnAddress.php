...
/**
 * PostReturnAddress Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class PostReturnAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'post_return_address';
     ...
     * Sets address_line_2
     *
     * @param string|null $address_line_2 The second line of the return address (optional).
     *
     * @return self
     */
     ...
     * Sets address_state
     *
     * @param string|null $address_state The state or region of the return address.
     *
     * @return self
     */
     ...
     *
     * @param string|null $address_postal_code The postal code or ZIP code of the return address.
     *
     * @return self
     */
     ...
     *
     * @param string|null $address_country The country of the return address.
     *
     * @return self
     */
