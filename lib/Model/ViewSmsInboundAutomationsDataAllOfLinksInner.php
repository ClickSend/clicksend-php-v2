...
/**
 * ViewSmsInboundAutomationsDataAllOfLinksInner Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewSmsInboundAutomationsDataAllOfLinksInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_sms_inbound_automations_data_allOf_links_inner';
     ...
     * Sets url
     *
     * @param string|null $url The URL of this page link.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The display label for this page link.
     *
     * @return self
     */
     ...
     * Sets page
     *
     * @param int|null $page The page number this link points to.
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool|null $active Whether this link represents the current page.
     *
     * @return self
     */
