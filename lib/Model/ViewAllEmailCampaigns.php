...
/**
 * ViewAllEmailCampaigns Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewAllEmailCampaigns implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view-all-email-campaigns';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\ViewAllEmailCampaignsData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewAllEmailCampaignsData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewAllEmailCampaignsData|null $data data
     *
     * @return self
     */
