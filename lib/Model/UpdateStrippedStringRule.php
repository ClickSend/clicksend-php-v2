...
/**
 * UpdateStrippedStringRule Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class UpdateStrippedStringRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'update-stripped-string-rule';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\ViewStrippedStringRuleData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewStrippedStringRuleData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewStrippedStringRuleData|null $data data
     *
     * @return self
     */
