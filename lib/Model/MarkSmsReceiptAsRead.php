...
/**
 * MarkSmsReceiptAsRead Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class MarkSmsReceiptAsRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'mark-sms-receipt-as-read';
     ...
     * Sets data
     *
     * @param object|null $data The parameters related to the SMS receipt.  <div class=\"warning-box\">   <h4><i class=\"fas fa-exclamation-triangle\"></i> Warning:</h4>   <p>This parameter is deprecated and will return <strong>null</strong/>.</p> </div>
     *
     * @return self
     */
