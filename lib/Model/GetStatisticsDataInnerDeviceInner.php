...
/**
 * GetStatisticsDataInnerDeviceInner Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class GetStatisticsDataInnerDeviceInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'get_statistics_data_inner_device_inner';
     ...
     * Sets label
     *
     * @param string|null $label Device name
     *
     * @return self
     */
     ...
     * Sets count
     *
     * @param float|null $count Total number of clicks on the short URL where the recipient has the specified device name
     *
     * @return self
     */
