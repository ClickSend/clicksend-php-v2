...
/**
 * CalculateMmsCampaignPriceData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CalculateMmsCampaignPriceData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'calculate_mms_campaign_price_data';
     ...
     * Sets total_price
     *
     * @param string|null $total_price The total price of the MMS campaign.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \ClickSend\Model\CalculateMmsCampaignPriceDataData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\CalculateMmsCampaignPriceDataData|null $data data
     *
     * @return self
     */
