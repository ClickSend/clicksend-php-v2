...
class Attachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        '_attachment_file_url' => '_attachment_file_url'
    ];
    ...
    protected static $setters = [
        ...
        '_attachment_file_url' => 'setAttachmentFileUrl'
    ];
    ...
    protected static $getters = [
        ...
        '_attachment_file_url' => 'getAttachmentFileUrl'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_attachment_file_url', $data ?? [], null);
    }
     ...
     * Sets file_name
     *
     * @param string|null $file_name The name of the attached file.
     *
     * @return self
     */
     ...
     * Sets content_type
     *
     * @param string|null $content_type The MIME type of the attached file.
     *
     * @return self
     */
     ...
     *
     * @param string|null $content_disposition The content disposition of the attached file.
     *
     * @return self
     */
     ...
     * Sets content_id
     *
     * @param string|null $content_id The content ID of the attached file.
     *
     * @return self
     */
    ...
    /**
     * Gets _attachment_file_url
     *
     * @return string|null
     */
    public function getAttachmentFileUrl()
    {
        return $this->container['_attachment_file_url'];
    }

    /**
     * Sets _attachment_file_url
     *
     * @param string|null $_attachment_file_url The URL to download the attached file.
     *
     * @return self
     */
    public function setAttachmentFileUrl($_attachment_file_url)
    {
        if (is_null($_attachment_file_url)) {
            throw new \InvalidArgumentException('non-nullable _attachment_file_url cannot be null');
        }
        $this->container['_attachment_file_url'] = $_attachment_file_url;
