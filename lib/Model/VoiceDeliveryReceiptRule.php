...
/**
 * VoiceDeliveryReceiptRule Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class VoiceDeliveryReceiptRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'voice_delivery_receipt_rule';
    ...
    protected static $setters = [
        'receipt_rule_id' => 'setReceiptRuleId',
    ...
    protected static $getters = [
        'receipt_rule_id' => 'getReceiptRuleId',
    ...
    {
        $this->setIfExists('receipt_rule_id', $data ?? [], null);
    ...
    /**
     * Gets receipt_rule_id
     *
     * @return int|null
     */
    public function getReceiptRuleId()
    {
        return $this->container['receipt_rule_id'];
    }

    /**
     * Sets receipt_rule_id
     *
     * @param int|null $receipt_rule_id The ID of the receipt rule.
     *
     * @return self
     */
    public function setReceiptRuleId($receipt_rule_id)
    {
        if (is_null($receipt_rule_id)) {
            throw new \InvalidArgumentException('non-nullable receipt_rule_id cannot be null');
        }
        $this->container['receipt_rule_id'] = $receipt_rule_id;
     ...
     * Sets rule_name
     *
     * @param string|null $rule_name The name of the receipt rule.
     *
     * @return self
     */
     ...
     * Sets match_type
     *
     * @param int|null $match_type The match type of the receipt rule.
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action The action of the receipt rule.
     *
     * @return self
     */
     ...
     * Sets action_address
     *
     * @param string|null $action_address The action address of the receipt rule.
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param int|null $enabled The enabled status of the receipt rule.
     *
     * @return self
     */
