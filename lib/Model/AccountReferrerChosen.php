...
/**
 * AccountReferrerChosen Class Doc Comment
 *
 * @category Class
 * @description The referral source chosen at sign-up, if any.
 * @package  ClickSend
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AccountReferrerChosen implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'account__referrer_chosen';
     ...
     * Sets id
     *
     * @param int|null $id The ID of the referral source.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the referral source.
     *
     * @return self
     */
