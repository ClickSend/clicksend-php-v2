...
/**
 * GetTrackingDataInnerContact Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class GetTrackingDataInnerContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'get_tracking_data_inner_contact';
     ...
     * Sets contact_id
     *
     * @param string|null $contact_id Contact ID of the recipient. Null if the recipient is not a contact.
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string|null $first_name First name of the recipient. Null if the recipient has no data for first name.
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name Last name of the recipient. Null if the recipient has no data last name.
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number Phone number of the recipient
     *
     * @return self
     */
