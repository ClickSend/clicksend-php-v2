...
/**
 * CurrentPaymentInfo Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CurrentPaymentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'current-payment-info';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\CurrentPaymentInfoData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\CurrentPaymentInfoData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\CurrentPaymentInfoData|null $data data
     *
     * @return self
     */
