...
/**
 * ViewSmsInboundAutomations Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewSmsInboundAutomations implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view-sms-inbound-automations';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\ViewSmsInboundAutomationsData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewSmsInboundAutomationsData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewSmsInboundAutomationsData|null $data data
     *
     * @return self
     */
