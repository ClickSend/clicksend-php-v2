...
/**
 * GetDefaultSendersListData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class GetDefaultSendersListData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'get_default_senders_list_data';
    ...
    protected static $openAPITypes = [
        'data' => '\ClickSend\Model\DefaultSender[]',
        'per_page' => 'int',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('self_page_url', $data ?? [], null);
     ...
     * Gets data
     *
     * @return \ClickSend\Model\DefaultSender[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\DefaultSender[]|null $data List of default senders.
     *
     * @return self
     */
    ...
    {
        return $this->container['self_page_url'];
    }

    /**
     * Sets self_page_url
     *
     * @param string|null $self_page_url URL for the current page.
     *
     * @return self
     */
    public function setSelfPageUrl($self_page_url)
    {
        if (is_null($self_page_url)) {
            throw new \InvalidArgumentException('non-nullable self_page_url cannot be null');
        }
        $this->container['self_page_url'] = $self_page_url;
     ...
     * Sets next_page_url
     *
     * @param string|null $next_page_url URL for the next page.
     *
     * @return self
     */
