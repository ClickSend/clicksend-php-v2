...
/**
 * CreateDeliveryIssue Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CreateDeliveryIssue implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'create-delivery-issue';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\CreateDeliveryIssueData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\CreateDeliveryIssueData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\CreateDeliveryIssueData|null $data data
     *
     * @return self
     */
