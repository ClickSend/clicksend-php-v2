...
/**
 * ViewEmailCampaignHistoryData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewEmailCampaignHistoryData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_email_campaign_history_data';
    ...
    protected static $openAPITypes = [
        ...
        'from' => 'int',
        'to' => 'int',
        'data' => '\ClickSend\Model\EmailCampaignHistory[]'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\EmailCampaignHistory[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\EmailCampaignHistory[]|null $data data
     *
     * @return self
     */
