...
/**
 * ViewFaxHistory Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewFaxHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view-fax-history';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\ViewFaxHistoryData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewFaxHistoryData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewFaxHistoryData|null $data data
     *
     * @return self
     */
