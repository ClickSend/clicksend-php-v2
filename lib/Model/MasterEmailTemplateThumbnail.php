...
/**
 * MasterEmailTemplateThumbnail Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class MasterEmailTemplateThumbnail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'master_email_template_thumbnail';
     ...
     * Sets small
     *
     * @param string|null $small The small thumbnail of the template.
     *
     * @return self
     */
     ...
     * Sets large
     *
     * @param string|null $large The large thumbnail of the template.
     *
     * @return self
     */
