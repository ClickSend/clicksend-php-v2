...
/**
 * ViewAllTransactions Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewAllTransactions implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view-all-transactions';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\ViewAllTransactionsData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewAllTransactionsData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewAllTransactionsData|null $data data
     *
     * @return self
     */
