...
/**
 * CalculateSmsPriceRequestMessagesInner Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CalculateSmsPriceRequestMessagesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'calculate_sms_price_request_messages_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('show_summary', $data ?? [], null);
    }
     ...
     * Sets contact_id
     *
     * @param string|null $contact_id The _contact_id_ of the contact to send the message to. A _contact_id_ is connected to a _list_id_. Use the [**Search Contact list**](/contacts/lists/#search-contact-lists) endpoint to view the _contact_id_ of the specified number. This parameter will be sent back to you with the response from the endpoint.  <div class=\"warning-box\">   <h4><i class=\"fas fa-exclamation-triangle\"></i> Warning:</h4>   <p>This parameter is no longer in use.</p> </div>
     *
     * @return self
     */
     ...
     * Sets show_summary
     *
     * @param bool|null $show_summary Used for showing additional information in the response. You can either specify:   - **True:** It will show the additional information.        - **False:** It will only show the basic information. This is the default value.
     *
     * @return self
     */
    public function setShowSummary($show_summary)
    {
        if (is_null($show_summary)) {
            throw new \InvalidArgumentException('non-nullable show_summary cannot be null');
        }
