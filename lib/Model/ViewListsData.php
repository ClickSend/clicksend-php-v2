...
/**
 * ViewListsData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewListsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_lists_data';
     ...
     * Sets total
     *
     * @param int|null $total The total number of contacts in the list.
     *
     * @return self
     */
     ...
     * Sets per_page
     *
     * @param int|null $per_page The number of contacts returned per page.
     *
     * @return self
     */
     ...
     * Sets last_page
     *
     * @param int|null $last_page The total number of pages.
     *
     * @return self
     */
     ...
     * Sets next_page_url
     *
     * @param string|null $next_page_url The URL of the next page of contacts.
     *
     * @return self
     */
     ...
     * Sets prev_page_url
     *
     * @param string|null $prev_page_url The URL of the previous page of contacts.
     *
     * @return self
     */
     ...
     * Sets from
     *
     * @param int|null $from The number of the first contact on the current page.
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param int|null $to The number of the last contact on the current page.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ContactList[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ContactList[]|null $data The contacts in the list.
     *
     * @return self
     */
