...
/**
 * ViewFaxReceiptsData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewFaxReceiptsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_fax_receipts_data';
    ...
    protected static $openAPITypes = [
        ...
        'from' => 'int',
        'to' => 'int',
        'data' => '\ClickSend\Model\FaxReceipt[]'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\FaxReceipt[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\FaxReceipt[]|null $data data
     *
     * @return self
     */
