...
class SendEmail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'send-email';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\TransactionalEmail'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\TransactionalEmail|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\TransactionalEmail|null $data data
     *
     * @return self
     */
