...
/**
 * ViewSpecificSmsCampaign Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewSpecificSmsCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view-specific-sms-campaign';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\SmsCampaign'
    ];
     ...
     * Sets response_code
     *
     * @param string|null $response_code The response code of the operation. Visit Visit [this page](/#status-codes) for more information.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \ClickSend\Model\SmsCampaign|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\SmsCampaign|null $data data
     *
     * @return self
     */
