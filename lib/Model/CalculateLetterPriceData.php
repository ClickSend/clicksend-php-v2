...
/**
 * CalculateLetterPriceData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CalculateLetterPriceData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'calculate_letter_price_data';
    ...
    protected static $openAPITypes = [
        'total_price' => 'float',
        'total_cost' => 'float',
        'recipients' => '\ClickSend\Model\Recipient[]'
    ];
     ...
     * Sets total_price
     *
     * @param float|null $total_price The total price of the letter.
     *
     * @return self
     */
     ...
     * Sets total_cost
     *
     * @param float|null $total_cost The total cost of the letter.
     *
     * @return self
     */
     ...
     * Gets recipients
     *
     * @return \ClickSend\Model\Recipient[]|null
     */
     ...
     * Sets recipients
     *
     * @param \ClickSend\Model\Recipient[]|null $recipients recipients
     *
     * @return self
     */
