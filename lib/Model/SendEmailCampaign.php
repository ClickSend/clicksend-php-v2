...
/**
 * SendEmailCampaign Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class SendEmailCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'send-email-campaign';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\SendEmailCampaignData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\SendEmailCampaignData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\SendEmailCampaignData|null $data data
     *
     * @return self
     */
