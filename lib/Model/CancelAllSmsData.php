...
/**
 * CancelAllSmsData Class Doc Comment
 *
 * @category Class
 ...
 */
class CancelAllSmsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'cancel_all_sms_data';
     ...
     * Sets count
     *
     * @param int|null $count The number of scehduled SMS cancelled.
     *
     * @return self
     */
