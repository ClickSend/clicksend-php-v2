...
/**
 * CalculateEmailCampaignPriceData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CalculateEmailCampaignPriceData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'calculate_email_campaign_price_data';
    ...
    protected static $openAPITypes = [
        ...
        'total_price' => 'string',
        'queued_count' => 'float',
        'data' => '\ClickSend\Model\CalculateEmailCampaignPriceDataData',
     ...
     * Sets total_count
     *
     * @param float|null $total_count The total count of the email campaigns.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \ClickSend\Model\CalculateEmailCampaignPriceDataData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\CalculateEmailCampaignPriceDataData|null $data data
     *
     * @return self
     */
