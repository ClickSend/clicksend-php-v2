...
/**
 * RemoveOptedOutContactsData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class RemoveOptedOutContactsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'remove_opted_out_contacts_data';
     ...
     * Sets deleted
     *
     * @param float|null $deleted The number of contacts deleted.
     *
     * @return self
     */
