...
/**
 * SendVoiceMessageData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class SendVoiceMessageData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'send_voice_message_data';
     ...
     * Sets total_price
     *
     * @param float|null $total_price The total price of the message.
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param float|null $total_count The total count of the message.
     *
     * @return self
     */
     ...
     * Sets queued_count
     *
     * @param float|null $queued_count The count of the queued message.
     *
     * @return self
     */
     ...
     * Gets messages
     *
     * @return \ClickSend\Model\VoiceMessage[]|null
     */
     ...
     * Sets messages
     *
     * @param \ClickSend\Model\VoiceMessage[]|null $messages messages
     *
     * @return self
     */
