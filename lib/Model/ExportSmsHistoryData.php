...
/**
 * ExportSmsHistoryData Class Doc Comment
 *
 * @category Class
 ...
 */
class ExportSmsHistoryData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'export_sms_history_data';
     ...
     * Sets url
     *
     * @param string|null $url The download link to the generated SMS history file.
     *
     * @return self
     */
