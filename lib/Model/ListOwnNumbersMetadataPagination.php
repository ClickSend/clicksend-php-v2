...
/**
 * ListOwnNumbersMetadataPagination Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ListOwnNumbersMetadataPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'list_own_numbers__metadata_pagination';
     ...
     * Sets self
     *
     * @param string|null $self The URL of the current page.
     *
     * @return self
     */
     ...
     * Sets next
     *
     * @param string|null $next The URL of the next page.
     *
     * @return self
     */
     ...
     * Sets page_size
     *
     * @param int|null $page_size The number of items returned per page.
     *
     * @return self
     */
