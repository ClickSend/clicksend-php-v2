...
/**
 * FaxDeliveryReceiptRule Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class FaxDeliveryReceiptRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'fax_delivery_receipt_rule';
     ...
     * Sets match_type
     *
     * @param int|null $match_type The type of match.
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action The action triggered by the rule.
     *
     * @return self
     */
