...
/**
 * ViewAllTransactionsDataAllOfDataInner Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewAllTransactionsDataAllOfDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_all_transactions_data_allOf_data_inner';
     ...
     * Sets date
     *
     * @param float|null $date The date of the transaction.
     *
     * @return self
     */
