...
/**
 * UserEmailTemplate Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class UserEmailTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'user_email_template';
     ...
     * Sets template_id
     *
     * @param int|null $template_id The unique identifier for the template.
     *
     * @return self
     */
