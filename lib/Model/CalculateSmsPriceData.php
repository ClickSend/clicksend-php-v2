...
/**
 * CalculateSmsPriceData Class Doc Comment
 *
 * @category Class
 ...
 */
class CalculateSmsPriceData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'calculate_sms_price_data';
     ...
     * Sets total_price
     *
     * @param float|null $total_price The total price of sending the messages. Visit [this page](/#status-codes) for more information.
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int|null $total_count The total number of messages sent from the request.
     *
     * @return self
     */
     ...
     * Sets queued_count
     *
     * @param int|null $queued_count The messages will be put in a queue if it goes through the validation process. The validation process checks whether the **Sender ID** is registered or not. Some countries don't require messages to go through the validation process.  Messages scheduled to be sent right away will be sent immediately. If not, it will be queued.
     *
     * @return self
     */
     ...
     * Gets messages
     *
     * @return \ClickSend\Model\Sms[]|null
     */
     ...
     * Sets messages
     *
     * @param \ClickSend\Model\Sms[]|null $messages The parameters related to messages.
     *
     * @return self
     */
     ...
     * Gets _summary
     *
     * @return \ClickSend\Model\CalculateSmsPriceDataSummary|null
     */
    public function getSummary()
    {
        return $this->container['_summary'];
    }

    /**
     * Sets _summary
     *
     * @param \ClickSend\Model\CalculateSmsPriceDataSummary|null $_summary _summary
     *
     * @return self
     */
    ...
    {
        if (is_null($_summary)) {
            throw new \InvalidArgumentException('non-nullable _summary cannot be null');
        }
        $this->container['_summary'] = $_summary;
     ...
     * Sets blocked_count
     *
     * @param int|null $blocked_count The number of messages unable to be sent. This is often caused by:  - Receipient’s country not enabled for global sending.      - Sender ID resitriction.      - Number registration restrcition.
     *
     * @return self
     */
