...
/**
 * ViewLetterHistoryData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewLetterHistoryData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_letter_history_data';
    ...
    protected static $openAPITypes = [
        ...
        'from' => 'int',
        'to' => 'int',
        'data' => '\ClickSend\Model\Recipient[]'
    ];
     ...
     * Sets data
     *
     * @param \ClickSend\Model\Recipient[]|null $data data
     *
     * @return self
     */
