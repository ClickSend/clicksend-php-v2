...
/**
 * CreateSmsInboundAutomationRequest Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CreateSmsInboundAutomationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'create_sms_inbound_automation_request';
    ...
    public function setMessageSearchTerm($message_search_term)
    {
        if (is_null($message_search_term)) {
            array_push($this->openAPINullablesSetToNull, 'message_search_term');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('message_search_term', $nullablesSetToNull);
            if ($index !== FALSE) {
