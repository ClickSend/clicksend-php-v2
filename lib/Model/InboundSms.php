...
class InboundSms implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'inbound_sms';
     ...
     * Sets timestamp
     *
     * @param int|null $timestamp The time you receive the inbound message.. It’s in the <a href=\"http://help.clicksend.com/what-is-a-unix-timestamp\">Unix format.</a>
     *
     * @return self
     */
     ...
     * Sets from
     *
     * @param string|null $from The sender of the message, which is the phone number of the recipient who replied to you. Your recipient can’t reply to an alpha tag (business name).
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string|null $body The message you received from your recipient.
     *
     * @return self
     */
     ...
     * Sets original_body
     *
     * @param string|null $original_body The last message you sent to your recipient.
     *
     * @return self
     */
     ...
     *
     * @param string|null $original_message_id The generated ID of the message that you sent to your receipient.
     *
     * @return self
     */
     ...
     * Sets custom_string
     *
     * @param string|null $custom_string A note that was included with the inbound SMS. If no note was included, the value will be an empty string.
     *
     * @return self
     */
     ...
     * Sets _keyword
     *
     * @param string|null $_keyword The keyword of the inbound SMS.  <div class=\"warning-box\">   <h4><i class=\"fas fa-exclamation-triangle\"></i> Warning:</h4>   <p>This parameter is deprecated and will return the first word of the body message.</p> </div>
     *
     * @return self
     */
