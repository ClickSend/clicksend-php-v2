...
/**
 * ViewVoiceStatisticsDataTotalOutbound Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewVoiceStatisticsDataTotalOutbound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_voice_statistics_data_total_outbound';
     ...
     * Sets count
     *
     * @param int|null $count The total count of outbound calls.
     *
     * @return self
     */
