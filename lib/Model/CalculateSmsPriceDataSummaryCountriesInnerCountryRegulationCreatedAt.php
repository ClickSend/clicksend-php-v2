...
/**
 * CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt Class Doc Comment
 *
 * @category Class
 ...
 */
class CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'calculate_sms_price_data__summary_countries_inner_country_regulation_created_at';
     ...
     * Sets date
     *
     * @param \DateTime|null $date The time you made the request. It will be in <a href=\"https://en.wikipedia.org/wiki/ISO_8601\" target=\"_blank\">ISO 8601</a> format.
     *
     * @return self
     */
     ...
     * Sets timezone_type
     *
     * @param int|null $timezone_type The offset value from the time you made the request.
     *
     * @return self
     */
     ...
     * Sets timezone
     *
     * @param string|null $timezone The timezone when you made the request.
     *
     * @return self
     */
