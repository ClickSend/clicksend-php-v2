...
/**
 * ViewAccountUsageDataSmsTotal Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewAccountUsageDataSmsTotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_account_usage_data_sms_total';
     ...
     * Sets count
     *
     * @param string|null $count The total count of SMS.
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param string|null $price The total price of SMS.
     *
     * @return self
     */
