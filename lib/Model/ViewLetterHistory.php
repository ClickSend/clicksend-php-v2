...
/**
 * ViewLetterHistory Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewLetterHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view-letter-history';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\ViewLetterHistoryData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewLetterHistoryData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewLetterHistoryData|null $data data
     *
     * @return self
     */
