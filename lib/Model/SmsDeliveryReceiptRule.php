...
/**
 * SmsDeliveryReceiptRule Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class SmsDeliveryReceiptRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'sms_delivery_receipt_rule';
     ...
     * Sets action
     *
     * @param string|null $action The type of action.
     *
     * @return self
     */
