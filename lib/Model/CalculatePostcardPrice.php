...
/**
 * CalculatePostcardPrice Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CalculatePostcardPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'calculate-postcard-price';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\SendPostcardData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\SendPostcardData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\SendPostcardData|null $data data
     *
     * @return self
     */
