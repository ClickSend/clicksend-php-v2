...
/**
 * ViewASpecificSmsTemplateData Class Doc Comment
 *
 * @category Class
 ...
 */
class ViewASpecificSmsTemplateData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_a_specific_sms_template_data';
     ...
     * Sets template_id
     *
     * @param int|null $template_id The generated ID of the template.
     *
     * @return self
     */
     ...
     * Sets template_name
     *
     * @param string|null $template_name The main content of the template.
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string|null $body The name of the template.
     *
     * @return self
     */
