...
/**
 * ViewInboundSmsData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewInboundSmsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_inbound_sms_data';
     ...
     * Sets data
     *
     * @param \ClickSend\Model\InboundSms[]|null $data The parameters related to the actual inbound SMS.
     *
     * @return self
     */
