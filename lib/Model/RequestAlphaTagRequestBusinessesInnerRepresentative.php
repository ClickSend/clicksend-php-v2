...
/**
 * RequestAlphaTagRequestBusinessesInnerRepresentative Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class RequestAlphaTagRequestBusinessesInnerRepresentative implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'request_alpha_tag_request_businesses_inner_representative';
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling RequestAlphaTagRequestBusinessesInnerRepresentative., must be smaller than or equal to 32.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling RequestAlphaTagRequestBusinessesInnerRepresentative., must be smaller than or equal to 32.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $email when calling RequestAlphaTagRequestBusinessesInnerRepresentative., must be smaller than or equal to 100.');
        }
