...
/**
 * ListOwnNumbers Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ListOwnNumbers implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'list-own-numbers';
    ...
    protected static $openAPITypes = [
        'own_numbers' => '\ClickSend\Model\OwnNumber[]',
    ...
    {
        $this->setIfExists('own_numbers', $data ?? [], null);
     ...
     * Gets own_numbers
     *
     * @return \ClickSend\Model\OwnNumber[]|null
     */
    public function getOwnNumbers()
    {
        return $this->container['own_numbers'];
    }

    /**
     * Sets own_numbers
     *
     * @param \ClickSend\Model\OwnNumber[]|null $own_numbers The list of own numbers.
     *
     * @return self
     */
    public function setOwnNumbers($own_numbers)
    {
        if (is_null($own_numbers)) {
            throw new \InvalidArgumentException('non-nullable own_numbers cannot be null');
        }
        $this->container['own_numbers'] = $own_numbers;
