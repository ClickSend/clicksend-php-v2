...
/**
 * ViewAccountUsage Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewAccountUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view-account-usage';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\ViewAccountUsageData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewAccountUsageData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewAccountUsageData|null $data data
     *
     * @return self
     */
