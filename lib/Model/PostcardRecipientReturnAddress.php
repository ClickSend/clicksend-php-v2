...
/**
 * PostcardRecipientReturnAddress Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class PostcardRecipientReturnAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postcard_recipient__return_address';
     ...
     * Sets user_id
     *
     * @param int|null $user_id The ID of the user associated with the return address.
     *
     * @return self
     */
     ...
     * Sets address_name
     *
     * @param string|null $address_name The name associated with the return address.
     *
     * @return self
     */
     ...
     * Sets address_line_1
     *
     * @param string|null $address_line_1 The first line of the return address.
     *
     * @return self
     */
     ...
     * Sets address_line_2
     *
     * @param string|null $address_line_2 The second line of the return address.
     *
     * @return self
     */
     ...
     * Sets address_city
     *
     * @param string|null $address_city The city of the return address.
     *
     * @return self
     */
     ...
     * Sets address_state
     *
     * @param string|null $address_state The state of the return address.
     *
     * @return self
     */
     ...
     *
     * @param string|null $address_postal_code The postal code of the return address.
     *
     * @return self
     */
     ...
     *
     * @param string|null $address_country The country code of the return address.
     *
     * @return self
     */
