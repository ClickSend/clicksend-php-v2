...
/**
 * UpdateEmailDeliveryReceiptRule Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class UpdateEmailDeliveryReceiptRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'update-email-delivery-receipt-rule';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\EmailDeliveryReceiptRule'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\EmailDeliveryReceiptRule|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\EmailDeliveryReceiptRule|null $data data
     *
     * @return self
     */
