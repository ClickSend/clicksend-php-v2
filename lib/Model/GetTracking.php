 ...
 */
class GetTracking implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'get-tracking';
    ...
    protected static $openAPITypes = [
        ...
        'data' => '\ClickSend\Model\GetTrackingDataInner[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['current_page_size']) && ($this->container['current_page_size'] > 100)) {
            $invalidProperties[] = "invalid value for 'current_page_size', must be smaller than or equal to 100.";
        }
     ...
     * Sets total
     *
     * @param float|null $total Total number of short URLs associated with the long URL ID
     *
     * @return self
     */
     ...
     * Sets per_page
     *
     * @param float|null $per_page The limit of tracking data per page
     *
     * @return self
     */
    public function setPerPage($per_page)
    {
        ...
        if (($per_page > 100)) {
            throw new \InvalidArgumentException('invalid value for $per_page when calling GetTracking., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param float|null $current_page_size The number of data in the current page
     *
     * @return self
     */
    public function setCurrentPageSize($current_page_size)
    {
        ...
        if (($current_page_size > 100)) {
            throw new \InvalidArgumentException('invalid value for $current_page_size when calling GetTracking., must be smaller than or equal to 100.');
        }
     ...
     * Sets prev_page_url
     *
     * @param string|null $prev_page_url Link to the previous page. This attribute will not be present if there is no previous page.
     *
     * @return self
     */
     ...
     * Sets next_page_url
     *
     * @param string|null $next_page_url Link to the next page. This attribute will not be present if there is no next page.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \ClickSend\Model\GetTrackingDataInner[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\GetTrackingDataInner[]|null $data Tracking data of the short URLs associated with the specified long URL ID. Note that only the data from the most recent click of the recipient (country, region, device, browser, and os) is recorded.
     *
     * @return self
     */
