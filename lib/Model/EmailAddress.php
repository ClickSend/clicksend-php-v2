...
class EmailAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'email_address';
     ...
     *
     * @param int|null $email_address_id The unique identifier for the email address.
     *
     * @return self
     */
     ...
     * Sets verified
     *
     * @param int|null $verified Flag indicating if the email address is verified.
     *
     * @return self
     */
     ...
     * Sets date_added
     *
     * @param string|null $date_added The date the email address was added.
     *
     * @return self
     */
