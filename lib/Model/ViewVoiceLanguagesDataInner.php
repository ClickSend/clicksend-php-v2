...
/**
 * ViewVoiceLanguagesDataInner Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewVoiceLanguagesDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_voice_languages_data_inner';
     ...
     * Sets code
     *
     * @param string|null $code The code of the language.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country The country of the language.
     *
     * @return self
     */
