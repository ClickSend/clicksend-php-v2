...
/**
 * ViewMmsHistoryData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewMmsHistoryData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_mms_history_data';
    ...
    protected static $openAPITypes = [
        ...
        'from' => 'int',
        'to' => 'int',
        'data' => '\ClickSend\Model\ViewMmsHistoryDataAllOfDataInner[]'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewMmsHistoryDataAllOfDataInner[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewMmsHistoryDataAllOfDataInner[]|null $data data
     *
     * @return self
     */
