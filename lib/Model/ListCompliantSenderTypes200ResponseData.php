...
/**
 * ListCompliantSenderTypes200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ListCompliantSenderTypes200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'list_compliant_sender_types_200_response_data';
    ...
    protected static $openAPITypes = [
        'data' => '\ClickSend\Model\ListCompliantSenderTypes200ResponseDataDataInner[]'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ListCompliantSenderTypes200ResponseDataDataInner[]
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ListCompliantSenderTypes200ResponseDataDataInner[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ListCompliantSenderTypes200ResponseData., number of items must be greater than or equal to 1.');
        }
