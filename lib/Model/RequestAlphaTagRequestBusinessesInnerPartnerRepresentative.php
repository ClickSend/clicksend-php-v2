...
/**
 * RequestAlphaTagRequestBusinessesInnerPartnerRepresentative Class Doc Comment
 *
 * @category Class
 * @description Partner&#39;s representative details. **Required** when &#x60;business_relationship&#x60; is &#x60;ENTITY_ASSOCIATE&#x60;. **Forbidden** otherwise.
 * @package  ClickSend
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RequestAlphaTagRequestBusinessesInnerPartnerRepresentative implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'request_alpha_tag_request_businesses_inner_partner_representative';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['first_name']) > 32)) {
        ...
        if ((mb_strlen($this->container['last_name']) > 32)) {
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling RequestAlphaTagRequestBusinessesInnerPartnerRepresentative., must be smaller than or equal to 32.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling RequestAlphaTagRequestBusinessesInnerPartnerRepresentative., must be smaller than or equal to 32.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $email when calling RequestAlphaTagRequestBusinessesInnerPartnerRepresentative., must be smaller than or equal to 100.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $title when calling RequestAlphaTagRequestBusinessesInnerPartnerRepresentative., must be smaller than or equal to 50.');
        }
