...
/**
 * ImportContactsData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ImportContactsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'import_contacts_data';
     ...
     * Sets ids
     *
     * @param string[]|null $ids The list of ids of the imported contacts.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id The list id of the imported contacts.
     *
     * @return self
     */
