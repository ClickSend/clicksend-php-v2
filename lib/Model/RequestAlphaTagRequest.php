...
/**
 * RequestAlphaTagRequest Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class RequestAlphaTagRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'request_alpha_tag_request';
    ...
    protected static $openAPITypes = [
        ...
        'reason' => 'string',
        'countries' => 'string[]',
        'businesses' => '\ClickSend\Model\RequestAlphaTagRequestBusinessesInner[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['countries']) && (count($this->container['countries']) > 1)) {
            $invalidProperties[] = "invalid value for 'countries', number of items must be less than or equal to 1.";
        }
        ...
        if (!is_null($this->container['businesses']) && (count($this->container['businesses']) > 1)) {
            $invalidProperties[] = "invalid value for 'businesses', number of items must be less than or equal to 1.";
        }

        if (!is_null($this->container['businesses']) && (count($this->container['businesses']) < 1)) {
            $invalidProperties[] = "invalid value for 'businesses', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets alpha_tag
     *
     * @param string|null $alpha_tag alpha_tag
     *
     * @return self
     */
    ...
    public function setCountries($countries)
    {
        ...
        if ((count($countries) > 1)) {
            throw new \InvalidArgumentException('invalid value for $countries when calling RequestAlphaTagRequest., number of items must be less than or equal to 1.');
        }
        if ((count($countries) < 1)) {
            throw new \InvalidArgumentException('invalid length for $countries when calling RequestAlphaTagRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets businesses
     *
     * @return \ClickSend\Model\RequestAlphaTagRequestBusinessesInner[]|null
     */
     ...
     * Sets businesses
     *
     * @param \ClickSend\Model\RequestAlphaTagRequestBusinessesInner[]|null $businesses businesses
     *
     * @return self
     */
    public function setBusinesses($businesses)
    {
        ...
        if ((count($businesses) > 1)) {
            throw new \InvalidArgumentException('invalid value for $businesses when calling RequestAlphaTagRequest., number of items must be less than or equal to 1.');
        }
        if ((count($businesses) < 1)) {
            throw new \InvalidArgumentException('invalid length for $businesses when calling RequestAlphaTagRequest., number of items must be greater than or equal to 1.');
        }
