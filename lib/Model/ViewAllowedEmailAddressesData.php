...
/**
 * ViewAllowedEmailAddressesData Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewAllowedEmailAddressesData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_allowed_email_addresses_data';
    ...
    protected static $openAPITypes = [
        ...
        'from' => 'int',
        'to' => 'int',
        'data' => '\ClickSend\Model\EmailAddress[]'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\EmailAddress[]|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\EmailAddress[]|null $data data
     *
     * @return self
     */
