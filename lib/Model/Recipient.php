...
class Recipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('post_pages', $data ?? [], null);
        $this->setIfExists('post_price', $data ?? [], null);
        $this->setIfExists('priority_post', $data ?? [], null);
     ...
     * Sets colour
     *
     * @param int|null $colour The color setting of the message.
     *
     * @return self
     */
     ...
     * Sets duplex
     *
     * @param int|null $duplex Whether the message is set to duplex printing.
     *
     * @return self
     */
    ...
    {
        return $this->container['post_pages'];
    }

    /**
     * Sets post_pages
     *
     * @param int|null $post_pages The number of pages in the postal message.
     *
     * @return self
     */
    public function setPostPages($post_pages)
    {
        if (is_null($post_pages)) {
            throw new \InvalidArgumentException('non-nullable post_pages cannot be null');
        }
        $this->container['post_pages'] = $post_pages;
     ...
     * Sets post_price
     *
     * @param string|null $post_price The price of the postal message.
     *
     * @return self
     */
     ...
     * Sets priority_post
     *
     * @param int|null $priority_post Whether the postal message is set to priority.
     *
     * @return self
     */
    public function setPriorityPost($priority_post)
    {
        if (is_null($priority_post)) {
            throw new \InvalidArgumentException('non-nullable priority_post cannot be null');
        }
