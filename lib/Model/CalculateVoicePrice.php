...
/**
 * CalculateVoicePrice Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CalculateVoicePrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'calculate-voice-price';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\SendVoiceMessageData'
    ];
     ...
     * Sets response_msg
     *
     * @param string|null $response_msg Here are your data.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \ClickSend\Model\SendVoiceMessageData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\SendVoiceMessageData|null $data data
     *
     * @return self
     */
