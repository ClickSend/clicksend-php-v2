...
class ContactList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'contact_list';
     ...
     * Sets list_id
     *
     * @param int|null $list_id The unique identifier for the list.
     *
     * @return self
     */
     ...
     * Sets list_name
     *
     * @param string|null $list_name The name of the list.
     *
     * @return self
     */
    ...
    {
        return $this->container['list_email_id'];
    }

    /**
     * Sets list_email_id
     *
     * @param string|null $list_email_id The email address id of the list.
     *
     * @return self
     */
    public function setListEmailId($list_email_id)
    {
        if (is_null($list_email_id)) {
            throw new \InvalidArgumentException('non-nullable list_email_id cannot be null');
        }
        $this->container['list_email_id'] = $list_email_id;

        return $this;
    }

    /**
     * Gets _contacts_count
     *
     * @return int|null
     */
    public function getContactsCount()
    {
        return $this->container['_contacts_count'];
    }

    /**
     * Sets _contacts_count
     *
     * @param int|null $_contacts_count The number of contacts in the list.
     *
     * @return self
     */
    public function setContactsCount($_contacts_count)
    {
        if (is_null($_contacts_count)) {
