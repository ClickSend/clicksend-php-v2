...
/**
 * MarkSpecificInboundSmsMessageAsRead Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class MarkSpecificInboundSmsMessageAsRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'mark-specific-inbound-sms-message-as-read';
     ...
     * Sets http_code
     *
     * @param int|null $http_code The HTTP code of the response. Visit [this page](/#status-codes) for more information.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param int|null $data The number of SMS marked as read.  If you have multiple inbound rules set to POLL, you will receive the inbound message multiple times. Reading it will mark all those messages as read.
     *
     * @return self
     */
