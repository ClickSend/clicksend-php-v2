...
/**
 * CreateTestSmsReceiptData Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateTestSmsReceiptData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'create_test_sms_receipt_data';
     ...
     * Sets timestamp_send
     *
     * @param int|null $timestamp_send The time you sent the test message. It is in <a target=\"_blank\" href=\"http://help.clicksend.com/what-is-a-unix-timestamp\">Unix format.</a>
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param int|null $timestamp The time you receive the test message receipt. It is in <a target=\"_blank\" href=\"http://help.clicksend.com/what-is-a-unix-timestamp\">Unix format.</a>
     *
     * @return self
     */
     ...
     * Sets message_id
     *
     * @param string|null $message_id The generated ID of the message. This ID is typically used as a reference for <a target=\"_blank\" href=\"https://www.clicksend.com/au/help/\">customer support</a> in case of any issues.  <div class=\"info-box\">   <h4><i class=\"fas fa-info-circle\"></i> Note:</h4>   <p>This <em>message_id</em> is different from the ID that is generated when sending or receving an actual SMS. This ID is used for testing only.</p> </div>
     *
     * @return self
     */
     ...
     * Sets status_code
     *
     * @param int|null $status_code The status code that is sent from the <a target=\"_blank\" href=\"https://en.wikipedia.org/wiki/SMS_gateway\">SMS gateway.</a> Visit <a target=\"_blank\" href=\"https://help.clicksend.com/article/8cc479qlbb-list-of-sms-gateway-error-codes\">this page</a> for more information.
     *
     * @return self
     */
     ...
     * Sets status_text
     *
     * @param string|null $status_text A message describing the _status_code_ of the operation. Visit <a target=\"_blank\" href=\"https://help.clicksend.com/article/8cc479qlbb-list-of-sms-gateway-error-codes\">this</a> page for more information.
     *
     * @return self
     */
     ...
     * Sets error_code
     *
     * @param int|null $error_code The error code of the operation. Visit <a target=\"_blank\" href=\"https://help.clicksend.com/article/8cc479qlbb-list-of-sms-gateway-error-codes\">this page</a> for more information. If no error occurred, the value is **null**.
     *
     * @return self
     */
     ...
     * Sets error_text
     *
     * @param string|null $error_text A message describing the _error_code_ of the operation. Visit <a target=\"_blank\" href=\"https://help.clicksend.com/article/8cc479qlbb-list-of-sms-gateway-error-codes\">this page</a> for more information. If no error occurred, the value is **null**.
     *
     * @return self
     */
     ...
     * Sets custom_string
     *
     * @param string|null $custom_string A note that was sent from the request.  <div class=\"warning-box\">   <h4><i class=\"fas fa-exclamation-triangle\"></i> Warning:</h4>   <p>This parameter is deprecated and will return <strong>null.</strong></p> </div>
     *
     * @return self
     */
     ...
     * Sets digits
     *
     * @param int|null $digits The numbers that the recipient pressed on their keypad during the call. A **null** value is returned if the recipient didn't provide any input.  <div class=\"info-box\">   <h4><i class=\"fas fa-info-circle\"></i> Note:</h4>   <p>This parameter is only relevant to <a href=\"/messaging/voice-messaging/\"><strong>Voice Messaging</strong></a> receipts.</p> </div>
     *
     * @return self
     */
