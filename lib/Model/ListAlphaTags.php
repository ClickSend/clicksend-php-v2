...
/**
 * ListAlphaTags Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ListAlphaTags implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'list-alpha-tags';
    ...
    protected static $openAPITypes = [
        'alpha_tags' => '\ClickSend\Model\AlphaTag[]',
        '_metadata' => '\ClickSend\Model\ListOwnNumbersMetadata'
    ];
    ...
    {
        $this->setIfExists('alpha_tags', $data ?? [], null);
        $this->setIfExists('_metadata', $data ?? [], null);
    }
     ...
     * Gets alpha_tags
     *
     * @return \ClickSend\Model\AlphaTag[]|null
     */
    public function getAlphaTags()
    {
        return $this->container['alpha_tags'];
    }

    /**
     * Sets alpha_tags
     *
     * @param \ClickSend\Model\AlphaTag[]|null $alpha_tags The list of alpha tags.
     *
     * @return self
     */
    public function setAlphaTags($alpha_tags)
    {
        if (is_null($alpha_tags)) {
            throw new \InvalidArgumentException('non-nullable alpha_tags cannot be null');
        }
        $this->container['alpha_tags'] = $alpha_tags;
     ...
     * Gets _metadata
     *
     * @return \ClickSend\Model\ListOwnNumbersMetadata|null
     */
     ...
     * Sets _metadata
     *
     * @param \ClickSend\Model\ListOwnNumbersMetadata|null $_metadata _metadata
     *
     * @return self
     */
    public function setMetadata($_metadata)
    {
        if (is_null($_metadata)) {
            throw new \InvalidArgumentException('non-nullable _metadata cannot be null');
        }
