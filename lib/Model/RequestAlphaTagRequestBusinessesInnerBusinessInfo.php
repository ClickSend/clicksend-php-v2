...
/**
 * RequestAlphaTagRequestBusinessesInnerBusinessInfo Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class RequestAlphaTagRequestBusinessesInnerBusinessInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'request_alpha_tag_request_businesses_inner_business_info';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['website']) > 128)) {
            $invalidProperties[] = "invalid value for 'website', the character length must be smaller than or equal to 128.";
        }
    ...
    public function setWebsite($website)
    {
        ...
        if ((mb_strlen($website) > 128)) {
            throw new \InvalidArgumentException('invalid length for $website when calling RequestAlphaTagRequestBusinessesInnerBusinessInfo., must be smaller than or equal to 128.');
        }
     ...
     * Sets phone_number
     *
     * @param string $phone_number E.164 or local format
     *
     * @return self
     */
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) > 15)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling RequestAlphaTagRequestBusinessesInnerBusinessInfo., must be smaller than or equal to 15.');
        }
