...
/**
 * ViewSmsStatistics Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewSmsStatistics implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view-sms-statistics';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\ViewSmsStatisticsData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewSmsStatisticsData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewSmsStatisticsData|null $data data
     *
     * @return self
     */
