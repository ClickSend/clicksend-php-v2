...
/**
 * CalculateLetterPrice Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CalculateLetterPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'calculate-letter-price';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\CalculateLetterPriceData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\CalculateLetterPriceData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\CalculateLetterPriceData|null $data data
     *
     * @return self
     */
