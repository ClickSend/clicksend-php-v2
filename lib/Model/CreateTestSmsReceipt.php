...
/**
 * CreateTestSmsReceipt Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CreateTestSmsReceipt implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'create-test-sms-receipt';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\CreateTestSmsReceiptData'
    ];
     ...
     * Sets http_code
     *
     * @param int|null $http_code The HTTP code of the response. Visit [this page](/#status-codes) for more information.  This parameter doesn’t reflect the status of each message. Check the _status_ parameter of the message object to view the status of the individual message.
     *
     * @return self
     */
     ...
     * Sets response_code
     *
     * @param string|null $response_code The response code of the operation. Visit [this page](/#status-codes) for more information.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \ClickSend\Model\CreateTestSmsReceiptData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\CreateTestSmsReceiptData|null $data data
     *
     * @return self
     */
