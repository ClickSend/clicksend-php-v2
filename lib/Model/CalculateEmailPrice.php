...
/**
 * CalculateEmailPrice Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class CalculateEmailPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'calculate-email-price';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\CalculateEmailPriceData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\CalculateEmailPriceData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\CalculateEmailPriceData|null $data data
     *
     * @return self
     */
