...
/**
 * ViewFaxInboundRules Class Doc Comment
 *
 * @category Class
 * @package  ClickSend
 * @author   OpenAPI Generator team
 ...
 */
class ViewFaxInboundRules implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view-fax-inbound-rules';
    ...
    protected static $openAPITypes = [
        ...
        'response_msg' => 'string',
        'data' => '\ClickSend\Model\ViewFaxInboundRulesData'
    ];
     ...
     * Gets data
     *
     * @return \ClickSend\Model\ViewFaxInboundRulesData|null
     */
     ...
     * Sets data
     *
     * @param \ClickSend\Model\ViewFaxInboundRulesData|null $data data
     *
     * @return self
     */
