...
/**
 * ViewSmsCampaignsData Class Doc Comment
 *
 * @category Class
 * @description The parameters related to the total SMS campaign shown. The response will depend on the query parameters.
 * @package  ClickSend
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ViewSmsCampaignsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'view_sms_campaigns_data';
     ...
     * Sets data
     *
     * @param \ClickSend\Model\SmsCampaign[]|null $data The parameters related to the SMS campaign.
     *
     * @return self
     */
