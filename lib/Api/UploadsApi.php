...
class UploadsApi
{
    ...
    /**
     * Operation uploadAMediaFile
     *
     * Upload Media File
     *
     * @param  string|null $content_type content_type (optional)
     * @param  object|null $body body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['uploadAMediaFile'] to see the possible values for this operation
     *
     * @throws \ClickSend\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function uploadAMediaFile($content_type = null, $body = null, string $contentType = self::contentTypes['uploadAMediaFile'][0])
    {
        $this->uploadAMediaFileWithHttpInfo($content_type, $body, $contentType);
    }

    /**
     * Operation uploadAMediaFileWithHttpInfo
     *
     * Upload Media File
     *
     ...
     */
    public function uploadAMediaFileWithHttpInfo($content_type = null, $body = null, string $contentType = self::contentTypes['uploadAMediaFile'][0])
    {
        $request = $this->uploadAMediaFileRequest($content_type, $body, $contentType);
    ...
    /**
     * Operation uploadAMediaFileAsync
     *
     * Upload Media File
     *
     * @param  string|null $content_type (optional)
     ...
     */
    public function uploadAMediaFileAsync($content_type = null, $body = null, string $contentType = self::contentTypes['uploadAMediaFile'][0])
    {
        return $this->uploadAMediaFileAsyncWithHttpInfo($content_type, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation uploadAMediaFileAsyncWithHttpInfo
     *
     * Upload Media File
     *
     * @param  string|null $content_type (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAMediaFileAsyncWithHttpInfo($content_type = null, $body = null, string $contentType = self::contentTypes['uploadAMediaFile'][0])
    {
        $returnType = '';
        $request = $this->uploadAMediaFileRequest($content_type, $body, $contentType);
    ...
    /**
     * Create request for operation 'uploadAMediaFile'
     *
     * @param  string|null $content_type (optional)
     * @param  object|null $body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['uploadAMediaFile'] to see the possible values for this operation
     ...
     */
    public function uploadAMediaFileRequest($content_type = null, $body = null, string $contentType = self::contentTypes['uploadAMediaFile'][0])
    {




        $resourcePath = '/v3/uploads';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
